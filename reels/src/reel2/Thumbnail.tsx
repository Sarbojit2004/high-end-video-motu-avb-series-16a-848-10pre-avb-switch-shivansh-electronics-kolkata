...
import { S16A } from "../assets";
import { headline, micro, spec, subhead, FONT_FACE_CSS } from "../fonts";

/**
 * REEL 2 THUMBNAIL — 1080x1920 portrait.
 *
 * Features the 16A, this reel's product, shown complete and uncropped
 * (`Plate` is object-fit: contain). Both logos sit directly on the light page,
 * unboxed, exactly as supplied. Both MOPs appear, visually segregated, because
 * the dual-category pricing is a fact about the whole line and belongs in every
 * reel. Everything sits inside the caption-safe zone.
 */
  ...
  <AbsoluteFill style={{ background: COLORS.paper }}>
    ...
    <AbsoluteFill style={{
      ...
      <div style={{ marginTop: 34, display: "flex", flexDirection: "column", gap: 16 }}>
        ...
        <div style={{ ...headline(126, 800), color: COLORS.ink, lineHeight: 0.96 }}>
          THIRTY-TWO<br />IN.<br />ONE 1U.
        </div>
        <div style={{ ...subhead(33, 500), color: COLORS.slate, maxWidth: 900 }}>
          MOTU 16A — sixteen balanced line inputs, sixteen DC-coupled outs, and
          the same engine as the 848 and 10pre.
        </div>
      </div>

      {/* the hero, complete and uncropped */}
      <div style={{ flex: 1, minHeight: 0, marginTop: 26, marginBottom: 22 }}>
        <Plate idx={S16A.qFront} style={{ width: "100%", height: "100%" }} />
      </div>
