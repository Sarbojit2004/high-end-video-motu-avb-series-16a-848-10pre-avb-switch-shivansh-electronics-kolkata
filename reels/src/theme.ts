// Design tokens — MOTU AVB Series ecosystem reels (portrait, light ground).
//
// PALETTE PROVENANCE (Section 2 / 8a): the Neumann TLM 107 reel this project is
// modelled on is a DARK-ground video — its `COLORS.ink` is #0C0D10 with #F4EFE6
// ivory type. Its type system, safe-margin structure, scene shell, rotating
// brand-plate cadence and two-layer audio pipeline all port directly; its colour
// values cannot. Every value below is re-derived for a light ground and checked
// against MOTU's dark brushed-metal chassis and RGB TFT display greens per Brief
// Stage 12. `motuBlue` is darkened from the supplied logo's #5898F8, which fails
...
export const REEL_META = {
  1: { id: "Reel1", title: "The Source", product: "MOTU 10pre",
       out: "motu-avb-reel-1-source" },
  2: { id: "Reel2", title: "The Matrix", product: "MOTU 16A",
       out: "motu-avb-reel-2-matrix" },
  3: { id: "Reel3", title: "The Command Center & Scale", product: "MOTU 848 + AVB Switch",
       out: "motu-avb-reel-3-command-scale" },
} as const;
