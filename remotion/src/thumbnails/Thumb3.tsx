...
/**
 * Part 3 thumbnail - the Atmos-ready monitoring story.
 *
 * English only (prompt s11). No added MOTU or Shivansh logo; any mark visible
 * is already baked into the supplied photograph.
 */
export const Thumb3: React.FC = () => (
  <AbsoluteFill style={{ background: C.bg }}>
    ...
    <AbsoluteFill style={{ padding: '150px 84px 120px', display: 'flex', flexDirection: 'column' }}>
      ...
      <div
        style={{
          fontFamily: F.head, fontSize: 200, fontWeight: 900, lineHeight: 0.8,
      ...
      <div
        style={{
          fontFamily: F.head, fontSize: 76, fontWeight: 800, lineHeight: 1.0,
          letterSpacing: '-0.025em', color: C.ink, marginTop: 16,
        }}
      >
        NATIVE ATMOS.
        <br />
        <span style={{ color: C.accent }}>ONE CLOCK SOURCE.</span>
      </div>
      ...
      >
        Twelve analog outputs — exactly
        <br />
        what the array needs. No aggregation.
      </div>

      {/* hero: the twelve-output bank, then the full front panel */}
      <div style={{ marginTop: 40 }}>
        <Plate a={90} height={330} radius={20} />
      </div>
      <div style={{ marginTop: 16 }}>
        <Plate a={86} height={250} radius={20} />
      </div>
