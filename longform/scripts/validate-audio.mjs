...
const NEED = {
  mindscape: 150, gifted: 128, diablo: 150, blackblue: 150, eternity: 120,
};
...
if (sfx.length < 14) fail(`expected >=14 SFX files, found ${sfx.length}`);
...
console.log(`   ${existsSync(vo) ? "present" : "absent (placeholder — narration recorded separately)"}: public/vo/voiceover-longform.mp3`);
