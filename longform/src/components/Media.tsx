...
/**
 * MACRO-TO-FULL-REVEAL (Section 3).
 *
 ...
 * and holds with a slow continuing drift. The macro phase occupies ~35% of the
 * beat and the reveal-and-hold ~65%, per the ratio the reference established.
 *
