// Type system ported from the Neumann TLM 107 long-form reference (Section 8a
// — "do not invent a new font system"). The woff2 files themselves are copied
...
// two genuinely editorial moments: the Hook/Problem chapter and the
// Transformation beat. The reference used the opposite balance, which suited a
// microphone; it does not suit rack-mount infrastructure.
