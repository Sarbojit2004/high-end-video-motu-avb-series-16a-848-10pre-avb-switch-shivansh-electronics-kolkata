...
//
// The brief is explicit that narration governs this reel's timing rather than
// the other way round (Section 10). Until the take exists, the edit is anchored
// to the script's derived timestamps at 165 wpm. Once the take exists, THIS is
// the tool that tells you where the real read differs from that, so the edit can
// be nudged to the voice instead of the voice being asked to hit the edit.
//
