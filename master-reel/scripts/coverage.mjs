...
console.log(`\n  beats: ${BEATS.length}   runtime: ${total}s   frames: ${TOTAL_FRAMES}   (target 298s / 8940)`);
...
console.log(`\nwrote ASSET_COVERAGE_MASTER_REEL.md`);
const pass = missing.length === 0 && unrendered.length === 0 && TOTAL_FRAMES === 8940;
