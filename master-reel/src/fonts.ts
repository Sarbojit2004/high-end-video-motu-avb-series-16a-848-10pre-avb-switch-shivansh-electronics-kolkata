...
// genuinely editorial beats. The reference used the opposite balance, which
// suited a microphone; it does not suit rack-mount infrastructure.
//
// SIZES ARE SET FOR A PHONE (Section 8b). Portrait reel text has to read at a
// glance at 1080x1920 on a handset, so every tier here sits well above what the
// landscape long format would need: headlines 96-132px, subheads 40-46px,
// spec values 52-72px, micro labels never below 24px.
...
/**
 * Stage 10 headline: bold, dominant, uppercase tracking to project authority.
 * Section 8b floor is 96px for headline-tier text.
 */
...
/** Stage 10 subheadline: medium weight, muted slate, contextual not competing. */
...
/** Stage 10 micro callout: small, highly legible, medium weight. */
